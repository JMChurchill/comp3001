...
//double pi_loop();
//double kern(int num_steps, int step);
//
//
//int main() {
//
...
//}
//
//double kern(int start, int finish, int step) {
//	int i, blk;
//	double x, sum = 0.0,sum1,sum2;
//	if (finish - start < BULK) {
//		for (i = start; i < num_steps; i++) {
//			x = (i + 0.5) * step;
//			sum = sum + 4.0 / (1.0 + x * x);
//		}
//	}
...
//		sum1 = pi_kernel(finish - blk / 2, finish, step);
